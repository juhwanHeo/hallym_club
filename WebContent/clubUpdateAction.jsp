...
<body>
	...
	<%
		...
		CV.setClub_id(Integer.parseInt(multipartRequest.getParameter("club_id")));
		...
		int result = new JDBC_clubDAO().updateClub(CV);
		if (result == -1) {
			out.print("<script>");
			...
			out.print("window.location = document.referrer;");
			out.print("</script>");
		}
	%>
