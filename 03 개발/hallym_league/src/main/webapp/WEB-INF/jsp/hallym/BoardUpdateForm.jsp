	                                            ...
	                                            <div class="b-con-box">
	                                                ...
	                                                <c:choose>
									            		<c:when test='${empty searchBoard.UPDATE_ID}'>
									            			<input data-valid-title="작성자" class="jwvalid-must b-input type02" type="text" id="writerNm" name="writer" value="${searchBoard.INPUT_ID}">
	                                                	</c:when>
									            		<c:otherwise>
									            			<input data-valid-title="작성자" class="jwvalid-must b-input type02" type="text" id="writerNm" name="writer" value="${searchBoard.UPDATE_ID}">
	                        							</c:otherwise>
									            	</c:choose>
	                                            </div>    
	                                        </div>
	                                        ...
	                                        <div class="b-row-box">
	                                            ...
	                                            <div class="b-con-box">
                                                    <input type="checkbox" id="fix_yn" name="fix_yn" value="Y"
                                                    	<c:if test='${searchBoard.FIX_YN eq "Y"}'>checked</c:if>
									            	>
