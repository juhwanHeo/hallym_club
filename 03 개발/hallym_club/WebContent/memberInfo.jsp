...
<body>
	...
	<ul>
		<form method="post" action="staff_update.jsp">
			...
			%>
			<input class="button" type="submit" name="btn" value="회장위임"
	...
	<table class="type03">
		<tr>
			...
			<td width="20%"><input type="text" name="MAJOR" id="MAJOR"
				readonly="readonly" value=<%=member_list.get(0).getMAJOR()%>></td>
			<td width="20%">학년<font>*</font></td>
			<td width="20%"><input type="text" name="GRADE" id="GRADE"
				readonly="readonly" value=<%=member_list.get(0).getGRADE()%>></td>
		</tr>
		<tr>
			<td>학번<font>*</font></td>
			<td><input type="text" name="STUDENT_ID" readonly="readonly"
				value=<%=member_list.get(0).getSTUDENT_ID()%>></td>

			<td>성명<font>*</font></td>
			<td><input type="text" style="width: 99%" name="NM" id="NM"
				readonly="readonly" value=<%=member_list.get(0).getNM()%>> <%
 ...
 %></td>
		...
		<%-- <tr>
			...
			<td colspan="3"><input type="text" style="width: 99%"
				...
				value=<%=member_list.get(0).getBIRTH_DT()%>></td>
		</tr> --%>
		<tr>
			<td>전화번호<font>*</font></td>
			<td colspan="3"><input type="text" style="width: 99%"
				name="PHONE_NO" id="PHONE_NO" readonly="readonly"
				value=<%=member_list.get(0).getPHONE_NO()%>></td>
		</tr>
		<tr>
			<td>주소</td>
			<td colspan="3"><input type="text" style="width: 99%"
				name="ADDRESS" readonly="readonly"
				value="<%=member_list.get(0).getADDRESS()%>"></td>
		</tr>
		<tr>
			<td>E-mail</td>
			<td colspan="3"><input type="text" style="width: 99%"
				name="EMAIL" readonly="readonly"
				value=<%=member_list.get(0).getEMAIL()%>></td>
		</tr>
		...
		<tr>
			...
			<td colspan="4" height="100px"><textarea
					...
					readonly="readonly"><%=member_list.get(0).getPlan()%> </textarea></td>
		</tr>
		...
		<tr>
			...
			<td colspan="4" height="80px"><textarea
					...
					readonly="readonly"><%=member_list.get(0).getHope()%></textarea></td>
		</tr>
